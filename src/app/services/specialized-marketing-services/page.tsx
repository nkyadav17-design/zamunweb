      ...
      <section className="hero relative w-full">
        <div className="max-w-7xl mx-auto text-center pt-30 pb-10">
          ...
          <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl font-light text-white tracking-tight leading-tight">
            In this Hyperconnected World Specialized Marketing is customized to audiences
          </h1>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center contact-form">
          ...
          <form className="grid gap-4">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <input placeholder="Your name" className="rounded-xl bg-white/[0.07] border border-white/10 px-4 py-3 text-white placeholder-zinc-400 focus:ring-2 focus:ring-violet-400/70" />
              <input placeholder="Your email" type="email" className="rounded-xl bg-white/[0.07] border border-white/10 px-4 py-3 text-white placeholder-zinc-400 focus:ring-2 focus:ring-violet-400/70" />
              <input placeholder="Website (optional)" className="rounded-xl bg-white/[0.07] border border-white/10 px-4 py-3 text-white placeholder-zinc-400 focus:ring-2 focus:ring-violet-400/70" />
            </div>
            <button type="submit" className="mt-2 bg-gradient-to-r from-violet-500 via-purple-500 to-cyan-400 text-white rounded-xl py-3 font-normal shadow-[0_10px_30px_rgba(99,102,241,0.4)] hover:shadow-[0_15px_40px_rgba(99,102,241,0.6)]">
              Send Message
            </button>
          </form>
        </div>
