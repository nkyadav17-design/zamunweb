...
const TIMELINE_STEPS = [
  ...
  {
    title: "Campaign Creation and Planning",
    body:
      "",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
const UNIQUENESS = [
  {
    ...
    body:
      " We identify where your audience actively searches for solutions—across both digital and offline touchpoints—and build the most efficient mix of channels to maximize ROI within your budget.",
  },
  {
    title: "Campaign Planning & Structuring",
    body:
      "We map out a detailed execution plan, aligning messaging, creative assets, and timelines to drive maximum reach, impressions, and engagement among key decision-makers.",
  },
  {
    title: "Seamless Campaign Execution",
    body:
      " Our team launches and manages campaigns with precision, ensuring timely roll-outs and consistent brand communication across all platforms.",
  },
  {
    title: "Real-Time Performance Monitoring",
    body:
      " We continuously track campaign effectiveness, optimize channel allocation, and fine-tune strategies to improve results as data comes in.",
  },
  {
    title: "Insights & Continuous Improvement",
    body:
      " Post-campaign, we analyze performance trends and extract actionable insights to strengthen future marketing initiatives and enhance long-term brand performance.",
  },
];
...
const FAQS = [
  {
    ...
    a:
      "Campaigns provide a focused approach to approaching your target audience. You get to know if your message and media choices are effective, given your market and money (budget) and the measurement of the performance helps in fine tuning your marketing strategy.",
  },
  {
    q: "Is it possible to track offline channels performance ?",
    a:
      "Yes! It can be done. Some common ways include unique promocodes for each channel, QR codes that the people  can scan, tracking their social media posts with your hashtags, etc.",
  },
  {
    q: "How many channels do I need to use ?",
    a:
      "It depends upon where your target audience goes frequently when they are looking for solutions. Since not everyone everywhere will choose the same channels every time, it’s a good idea to use multiple channels, say 2 or 3 top begin with. Budget is an important factor to consider. Lastly, the number can increase or decrease as you analyse the performance of your campaigns over time and as the channels’ popularities change.",
  },
];
