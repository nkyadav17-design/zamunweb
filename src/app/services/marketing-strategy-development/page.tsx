...
const slug = "marketing-strategy-development";
const title = "Marketing Strategy Development";

export default function MarketingStrategyPage() {
  const mainRef = useRef<HTMLDivElement | null>(null);

  /* ✅ Uses the visible FAQS on THIS page (dynamic) */
          ...
          <div className="max-w-6xl mx-auto px-6 grid gap-10 md:grid-cols-[1fr_420px] items-center">
            <div className="blog-text">
              ...
              <h4 className="text-2xl sm:text-3xl font-semibold mb-4">
                The Strategic Role of Global Capability Centres (GCCs) in India’s
                Growth Story
              </h4>
              <Link
...
const TIMELINE_STEPS = [
  {
    ...
    body: "To identify customer’s need, preferences, competitor’s approach and potential gaps.",
    icon: (
  ...
  },
  {
    ...
    body: "To identify what is the potential value proposition that the company can offer.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor">
  ...
  },
  {
    ...
    body: "That outlines potential overlap where need gaps can be filled by the company’s capabilities.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor">
  ...
  },
  {
    ...
    body: "Where the company needs to increase its capability to fill the gaps through new solutions.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor">
  ...
  },
  {
    ...
    body: "To increase awareness through a mix of personality, content, channel presence.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
const UNIQUENESS = [
  { title: "Deep strategy expertise", body: "to understand company strategy, and to align marketing to the same" },
  { title: "High hands-on direct operations experience.", body: "We have directly delivered on marketing and product strategies in many industries, and hence understand how to actually create good products and solutions" },
  { title: "Analytical, numbers first approach,", body: "to ensure that actions have defined positive commercial and economic impact on the customers and us. This step includes the whole range of secondary research." },
  { title: "Detailed stakeholder interactions", body: "not just at the senior level, but at the actioning level. Having hundreds of interviews and correlating that with internal and benchmark data where available. This is a specialized way of conducting primary technical deep dives, along with technical experts." },
  { title: "Conducting multi-day process immersion", body: "session including shadowing to understand the real situation and not just how people perceive it. This is a specialized way of conducting primary research." },
  { title: "Creating actionable solutions", body: "that can be enacted by the resources available or by making resources available through our network." },
  { title: "Creating an Estimate of Value", body: "and constructing a proof-of-value measurement dashboard to regularly see how the strategy is being executed and creating value." },
];
