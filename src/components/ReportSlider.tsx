    ...
    <section className="min-h-[70vh] w-full bg-gradient-to-b from-[#08050F] via-[#0E0A1F] to-[#0B0A1B] text-white py-24 px-6 sm:px-12 md:px-20 overflow-hidden">
      ...
      <div className="flex flex-col items-start justify-between sm:flex-row sm:items-center mb-12">
        <motion.h1
          ...
          viewport={{ once: true }}
          className="text-4xl sm:text-5xl font-light tracking-wide mt-10 mb-6 md:mt-16 md:mb-12"
        >
          {heading}
        </motion.h1>
      ...
      <div className="relative">
        {/* Edge fades */}
        <div className="pointer-events-none absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-[#08050F] to-transparent z-10" />
        <div className="pointer-events-none absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-[#0B0A1B] to-transparent z-10" />
